...
import { useOperators, useApproveOrganization, useRejectOrganization, useSuspendOrganization } from "@/hooks/use-organizations"
...
function ActionsCell({ row }: { row: Organization }) {
  ...
  const perms = usePermissions("operators", ["approve", "reject", "suspend"])
    ...
    <>
      ...
      <Dialog open={rejectOpen} onOpenChange={setRejectOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>Reject Operator</DialogTitle>
          </DialogHeader>
